...
A[1,] # whole first row
A[2,] # whole second row
A[3,] # whole third row

A[,1] # whole first column
A[,2] # whole second column
A[,3] # whole third column
